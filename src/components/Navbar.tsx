...
const NAV_LINKS = [
  ...
  { name: 'Language Classes', href: '/language-class' },
  { name: 'COE/Visa Support', href: '/coe-visa-support' },
  { name: 'Cost & Requirements', href: '/cost-and-requirements' },
  { name: 'Partner Schools', href: '/partner-schools' },
  { name: 'For Parents', href: '/for-parents' },
  { name: 'Life in Japan', href: '/life-in-japan' },
  { name: 'FAQ', href: '/faq' },
    ...
    <>
      ...
      >
        ...
        <Link href="/" className="flex items-center">
          <Image src="/images/yms-logo-transparent.png" alt="YMS Education Logo" width={185} height={48} className="object-contain mix-blend-multiply" priority />
        </Link>
